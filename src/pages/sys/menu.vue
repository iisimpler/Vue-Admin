    ...
    <el-row slot="body">
      ...
      <el-col :span="18">
        <el-card class="box-card" style="margin-left: 15px">
          ...
          <el-dialog title="选择图标" v-model="selectIconDialog" size="large">
            <div class="select-tree">
              <el-scrollbar
                ...
                <div class="icons-wrapper">
                  ...
                  <i class="fa fa-clipboard"></i><i class="fa fa-clock-o" @click="selectIcon($event)"></i>
                  ...
                  <i class="fa fa-user-o"></i><i class="fa fa-user-plus" @click="selectIcon($event)"></i>
                  ...
                  <i class="fa fa-wrench" @click="selectIcon($event)"></i></div>
              </el-scrollbar>
            </div>
